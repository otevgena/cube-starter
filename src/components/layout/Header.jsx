...
export default function Header() {
  ...
  /* === Dev-хуки (удобно для VCE): Alt+S открыть/закрыть, Esc закрыть; функции в консоли === */
  React.useEffect(() => {
    const onKey = (e) => {
      ...
      <div className="container-header" style={{ height: "var(--header-height)" }}>
        ...
        <div
          ...
          style={{
            ...
            transform:
              "translate(var(--header-stack-offset-x), var(--header-stack-offset-y))",
          }}
        >
          {/* ЛОГО "c." */}
          <div
          ...
          {/* Поиск в шапке (высота синхронизирована переменной) */}
          <div className="flex-1 hidden md:flex justify-center">
            <div className="search-wrap w-full" style={{ maxWidth: "var(--header-search-max)" }}>
          ...
          <div className="ml-auto hidden md:flex items-center gap-4">
            ...
            {/* НОВОЕ: Регистрация рядом с "Вход" */}
            ...
            <div
              ...
              style={{
                transform:
                  "translate(var(--actions-offset-x), var(--actions-offset-y))",
              }}
            >
              ...
              >
                ...
                <div className="panel-bar flex items-center justify-between mb-3">
                  ...
                  <div className="panel-bar-right flex items-center gap-4">
                    ...
                    {/* НОВОЕ: Регистрация и здесь */}
                    <a href="/register" className="nav-link">
                      <span className="text-grad-222">Регистрация</span>
                    </a>
                    <a href="/pro" className="btn-pro" style={{ height: "var(--diamond)" }}>
                      Be Pro
                    </a>
                    <a href="/submit" className="btn-submit" style={{ height: "var(--diamond)" }}>
                      Submit Website
                    </a>
                  </div>
                </div>
                ...
                <div className="services-top">
                  ...
                  >
                    <div className="search-wrap search-wrap--white">
                      <Search size={18} className="text-[#4a4a4a]" />
                      <input
                        type="text"
                ...
                <div className="services-body">
                  <div className="svc-left">
                    <a className="svc-left-item is-active">
                      <Trophy size={18} className="svc-ico" />
                      <span>Awards</span>
                    </a>
                    <a className="svc-left-item">
                      <Layers size={18} className="svc-ico" />
                      <span>By Category</span>
                    </a>
                    <a className="svc-left-item">
                      <Cpu size={18} className="svc-ico" />
                      <span>By Technology</span>
                    </a>
                    <a className="svc-left-item">
                      <FolderOpen size={18} className="svc-ico" />
                      <span>Collections</span>
                    </a>
                    <a className="svc-left-item">
                      <Newspaper size={18} className="svc-ico" />
                      <span>Blog</span>
                    </a>
                  </div>
                  ...
                  <div className="svc-right">
                    <div className="svc-row">
                      <span className="svc-label">Honor Mentions</span>
                      <span className="svc-num">25K</span>
                    </div>
                    <div className="svc-row">
                      <span className="svc-label">Nominees</span>
                      <span className="svc-num">48K</span>
                    </div>
                    <div className="svc-row is-active">
                      <span className="svc-label">Sites of the Day</span>
                      <span className="svc-num">6076</span>
                    </div>
                    <div className="svc-row">
                      <span className="svc-label">Sites of the Month</span>
                      <span className="svc-num">195</span>
                    </div>
                    <div className="svc-row">
                      <span className="svc-label">Sites of the Year</span>
                      <span className="svc-num">64</span>
                    </div>
                    <div className="svc-row">
                      <span className="svc-label">Honors</span>
                      <span className="svc-num">
                        <span className="badge-new">New</span>
                      </span>
                    </div>
                    <div className="svc-row">
                      <span className="svc-label">Most Awarded Profiles</span>
                    </div>
                    <div className="svc-row">
                      <span className="svc-label">Jury 2025</span>
                    </div>
                  </div>
                </div>
              </div>
