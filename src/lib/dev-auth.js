// src/lib/dev-auth.js
// ВРЕМЕННЫЙ dev-вход без бэкенда. Активен только в dev (см. main.jsx → import.meta.env.DEV),
// в production-сборку не попадает. Перехватывает /auth/* и /admin/* и отдаёт фейковых пользователей.
//
// Тестовые аккаунты (вводить в модалке «Вход»):
//   admin@cube.ru / 1234  — администратор (видит вкладку «Администратор»)
//   user@cube.ru  / 1234  — обычный пользователь
//
// Чтобы убрать: удалить этот файл и вызов installDevAuth() в main.jsx.
