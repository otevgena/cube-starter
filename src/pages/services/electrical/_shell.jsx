  ...
  return (
    <main style={{ background: BG, minHeight: "100dvh", fontFamily: UI, color: INK }}>
      ...
      <div className="-mt-12 text-center will-change-transform lg:mt-0 lg:-translate-y-[61px]">
        ...
        <h1
          className="mt-2 text-[clamp(24px,8.5vw,34px)] sm:text-[clamp(48px,13.5vw,137px)] md:text-[clamp(40px,6vw,52px)] lg:mt-0.5 lg:text-[clamp(44px,7.5vw,88px)] xl:text-[clamp(48px,13.5vw,137px)]"
