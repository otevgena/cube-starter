// src/pages/services/design/_shell.jsx
// Верх детальных страниц «Проектирование»: вкладки + заголовок + слоган +
// «Обновление» и низ «← Всё проектирование». Композиция верха — как в других разделах.
...
const TABS = [
  { label: "Проект электроснабжения (ЭОМ)", href: "/services/design/power-eom" },
  { label: "Проект ОВ и ВК", href: "/services/design/hvac-vk" },
  { label: "Проект СС (слаботочные системы)", href: "/services/design/lowcurrent-ss" },
  { label: "АСУ ТП и разделы автоматики", href: "/services/design/automation-asutp" },
  { label: "Молниезащита и заземление", href: "/services/design/lightning-earthing" },
  { label: "Сметная документация", href: "/services/design/estimate-documentation" },
  { label: "Авторский надзор", href: "/services/design/author-supervision" },
  { label: "Согласования в сетевых организациях", href: "/services/design/network-approvals" },
];
