...
export function UnderInput({ value, onChange, placeholder, type = "text", maxLength, upper, inputMode, onBlur }) {
  return (
    <input type={type} inputMode={inputMode} value={value} maxLength={maxLength} onChange={(e) => onChange && onChange(e.target.value)} placeholder={placeholder} className="obj-ph"
      ...
      onBlur={(e) => { e.currentTarget.style.boxShadow = `inset 0 -1px 0 0 ${UNDER}`; onBlur && onBlur(e.target.value); }} />
  );
}
